...
<template>
  <div class="w-full h-full bg-gradient-to-r from-indigo-400 to-blue-600">
    <div class="px-2 py-8 mx-4 sm:px-0">
      <TabGroup>
        <TabList
          class="flex p-1 space-x-1 bg-blue-900 bg-opacity-20 rounded-xl"
        >
          <Tab
